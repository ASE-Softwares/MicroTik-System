    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseAdmins" class="collapse" aria-labelledby="AdminUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('admin.raw_purchase.form') }}">Record New</a>
                        <a></a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseWiredClients" aria-expanded="true" aria-controls="collapseWiredClients">
                    <i class="fa fa-plug" aria-hidden="true"></i>
                    <span>Wired Clients</span>
                </a>
                <div id="collapseWiredClients" class="collapse" aria-labelledby="AdminUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Clients:</h6>
                        <a class="collapse-item" href="{{ route('wired_clients.index') }}"> <i class="fa fa-users" aria-hidden="true"></i> View All</a>
                        <a class="collapse-item" href="{{ route("wired_clients.create") }}"><i class="fa fa-user-plus" aria-hidden="true"></i> Add Client</a>
                        <h6 class="collapse-header">Subscriptions:</h6>
                        <a class="collapse-item" href="{{ route('subscriptions.index') }}"><i class="fa fa-cogs" aria-hidden="true"></i> Manage Subscriptions</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                ...
                                <a class="dropdown-item" href="{{ route('change-router') }} " onclick="event.preventDefault();
