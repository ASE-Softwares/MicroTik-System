...
<div class="tabs tabs-full">
    ...
    <label for="tab3" class="tab-label">
        ...
        <br />
        {{ trans('installer_messages.environment.wizard.tabs.router') }}
    </label>
    ...
    <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
        ...
        <div class="tab" id="tab3content">
            <div class="block">
                <input type="radio" name="appSettingsTabs" id="appSettingsTab4" value="null" checked />
                <label for="appSettingsTab4">
                    <span>
                        {{ trans('installer_messages.environment.wizard.form.app_tabs.router_title') }}
                    </span>
                </label>
                <div class="form-group {{ $errors->has('remote_router_host') ? ' has-error ' : '' }}">
                    <label for="remote_router_host">
                        {{ trans('installer_messages.environment.wizard.form.remote_router_host_label') }}
                    </label>
                    <input type="text" name="remote_router_host" id="remote_router_host" value="" placeholder="192.168.43.1" required />

                    @if ($errors->has('remote_router_host'))
                    <span class="error-block">
                        <i class="fa fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
                        {{ $errors->first('remote_router_host') }}
                    </span>
                    @endif
                </div>

                <div class="form-group {{ $errors->has('remote_router_user') ? ' has-error ' : '' }}">
                    <label for="remote_router_user">
                        {{ trans('installer_messages.environment.wizard.form.remote_router_user_label') }}
                    </label>
                    <input type="text" name="remote_router_user" id="remote_router_user" value="" placeholder="admin" required />

                    @if ($errors->has('remote_router_user'))
                    <span class="error-block">
                        <i class="fa fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
                        {{ $errors->first('remote_router_user') }}
                    </span>
                    @endif
                </div>

                <div class="form-group {{ $errors->has('remote_router_pass') ? ' has-error ' : '' }}">
                    <label for="remote_router_pass">
                        {{ trans('installer_messages.environment.wizard.form.remote_router_password_label') }}
                    </label>
                    <input type="password" name="remote_router_pass" id="remote_router_pass" value="" placeholder="" required />

                    @if ($errors->has('remote_router_pass'))
                    <span class="error-block">
                        <i class="fa fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
                        {{ $errors->first('remote_router_pass') }}
                    </span>
                    @endif
                </div>

                <div class="form-group {{ $errors->has('remote_router_port') ? ' has-error ' : '' }}">
                    <label for="remote_router_port">
                        {{ trans('installer_messages.environment.wizard.form.remote_router_port_label') }}
                    </label>
                    <input type="number" name="remote_router_port" id="remote_router_port" placeholder="" required />

                    @if ($errors->has('remote_router_port'))
                    <span class="error-block">
                        <i class="fa fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
                        {{ $errors->first('remote_router_port') }}
                    </span>
                    @endif
                </div>
                <div class="buttons">
                    <button class="button" onclick="lastStep();return false">
                        Continue
                        <i class="fa fa-angle-right fa-fw" aria-hidden="true"></i>
                    </button>
                </div>
